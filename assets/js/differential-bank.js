...
(function (global) {
  ...
  /* ==================================================================== 4
     BACCALAUREATE II — លំហាត់ធ្លាប់ចេញបាក់ឌុប (pp. 99–102)

     The differential-equation question as it was actually set in the national
     examination, one entry per year. 2003 and 2020 are absent from the source.
     The final entry is the workbook's own "what might come next" question, so
     it carries no year — it is printed there as ២០២…?                      */
  function bc(year, km, en, parts) {
    return { n: year, kind: 'bac', q: { km: km, en: en }, p: parts || [] };
  }

  var BACC = [
    bc('2002',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): 2y\'\'-3y\'+y = 0\\)។',
      'Consider \\((E): 2y\'\'-3y\'+y = 0\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'កំណត់ចម្លើយ \\(g(x)\\) មួយរបស់សមីការ \\((E)\\) ដើម្បីឲ្យក្រាបតាងអនុគមន៍ \\(g\\) ប៉ះនឹងបន្ទាត់ \\(d\\) ដែលមានសមីការ \\(y = -\\dfrac{1}{2}x\\) ត្រង់ចំណុច \\(O(0,0)\\)។',
              'Determine a solution \\(g(x)\\) of \\((E)\\) whose curve is tangent to the line \\(d: y = -\\dfrac{1}{2}x\\) at the origin \\(O(0,0)\\).')
    ]),

    bc('2004',
      'ដោះស្រាយសមីការ \\(y\'\'+4y = 0\\) បើ \\(y(0) = 1\\), \\(y\'(0) = -1\\)។',
      'Solve \\(y\'\'+4y = 0\\) given \\(y(0) = 1\\), \\(y\'(0) = -1\\).', []),

    bc('2005',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'+5y\'+6y = 0\\)។',
      'Consider \\((E): y\'\'+5y\'+6y = 0\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'កំណត់ចម្លើយមួយនៃសមីការ \\((E)\\) បើគេដឹងថាបន្ទាត់ \\(D: y = x-1\\) ប៉ះក្រាបនៃចម្លើយត្រង់ \\(x = 0\\)។',
              'Determine a solution of \\((E)\\) whose curve has \\(D: y = x-1\\) as its tangent at \\(x = 0\\).')
    ]),

    bc('2006',
      'ដោះស្រាយសមីការ \\(y\'\'-2y\'+5y = 0\\) ដោយដឹងថា \\(y(0) = -1\\), \\(y\'(0) = 1\\)។',
      'Solve \\(y\'\'-2y\'+5y = 0\\) given \\(y(0) = -1\\), \\(y\'(0) = 1\\).', []),

    bc('2007',
      'គេមានសមីការ \\((E): y\'-y\\ln 3 = 0\\)។',
      'Consider \\((E): y\'-y\\ln 3 = 0\\).', [
      p2('a', 'រកសំណុំចម្លើយនៃ \\((E)\\)។', 'Find the general solution of \\((E)\\).'),
      p2('b', 'កំណត់ \\(f\\) ដែលជាចម្លើយនៃ \\((E)\\) ដោយដឹងថា \\(f(1) = 2\\)។',
              'Determine \\(f\\), the solution of \\((E)\\) with \\(f(1) = 2\\).'),
      p2('c', 'បង្ហាញថា \\(g(x) = 3^{x-1}\\) ជាចម្លើយនៃ \\((E)\\)។ (សម្គាល់៖ បើ \\(U(x) = a^{x}\\) នោះ \\(U\'(x) = a^{x}\\ln a\\))',
              'Show that \\(g(x) = 3^{x-1}\\) is a solution of \\((E)\\). (Note: if \\(U(x) = a^{x}\\) then \\(U\'(x) = a^{x}\\ln a\\).)')
    ]),

    bc('2008',
      'គេឲ្យសមីការឌីផេរ៉ង់ស្យែល \\(f\'\'+2f\' = 0\\)។',
      'Consider the differential equation \\(f\'\'+2f\' = 0\\).', [
      p2('1', 'តាង \\(g = f\'\\)។ បង្ហាញថា \\(g\\) ជាចម្លើយនៃសមីការ \\(g\'+2g = 0\\)។',
              'Let \\(g = f\'\\). Show that \\(g\\) is a solution of \\(g\'+2g = 0\\).'),
      p2('2', 'ដោះស្រាយសមីការ \\(g\'+2g = 0\\) រួចទាញរកចម្លើយនៃសមីការ \\(f\'\'+2f\' = 0\\)។',
              'Solve \\(g\'+2g = 0\\), then deduce the solution of \\(f\'\'+2f\' = 0\\).')
    ]),

    bc('2009',
      'គេឲ្យសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'-3y\'+2y = 2x+1\\)។',
      'Consider \\((E): y\'\'-3y\'+2y = 2x+1\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\((E_1): y\'\'-3y\'+2y = 0\\)។ កំណត់ចម្លើយ \\(f\\) នៃ \\((E_1)\\) ដែល \\(f(0) = 3\\) និង \\(f\'(0) = 4\\)។',
              'Solve \\((E_1): y\'\'-3y\'+2y = 0\\). Determine the solution \\(f\\) of \\((E_1)\\) with \\(f(0) = 3\\) and \\(f\'(0) = 4\\).'),
      p2('b', 'កំណត់ចំនួនពិត \\(a\\) និង \\(b\\) ដើម្បីឲ្យ \\(g(x) = ax+b\\) ជាចម្លើយនៃ \\((E)\\)។',
              'Determine the real numbers \\(a\\) and \\(b\\) so that \\(g(x) = ax+b\\) is a solution of \\((E)\\).')
    ]),

    bc('2010',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((\\alpha): y\'\'-6y\'+8y = 0\\)។',
      'Consider \\((\\alpha): y\'\'-6y\'+8y = 0\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\(y\'\'-6y\'+8y = 0\\;(\\alpha)\\)។', 'Solve \\(y\'\'-6y\'+8y = 0\\;(\\alpha)\\).'),
      p2('b', 'រកអនុគមន៍ \\(g\\) ដែលជាចម្លើយមួយនៃ \\((\\alpha)\\) ដោយដឹងថាក្រាប \\(G\\) របស់វាប៉ះនឹងបន្ទាត់ដេកមួយនៅត្រង់ \\(E(0,-1)\\)។',
              'Find the function \\(g\\), a solution of \\((\\alpha)\\), whose curve \\(G\\) has a horizontal tangent at \\(E(0,-1)\\).')
    ]),

    bc('2011',
      'គេឲ្យសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'-2y\'+5y = nx^{2}+px+q\\)។',
      'Consider \\((E): y\'\'-2y\'+5y = nx^{2}+px+q\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\((F): y\'\'-2y\'+5y = 0\\)។ រកចម្លើយនៃ \\((F)\\) បើ \\(y(0) = 2\\) និង \\(y\'(0) = 6\\)។',
              'Solve \\((F): y\'\'-2y\'+5y = 0\\). Find the solution of \\((F)\\) with \\(y(0) = 2\\) and \\(y\'(0) = 6\\).'),
      p2('b', 'រកចំនួនពិត \\(n\\), \\(p\\) និង \\(q\\) ដោយដឹងថា \\(y = 2x^{2}+3x+1\\) ជាចម្លើយនៃសមីការ \\((E)\\)។ រួចរកចម្លើយទូទៅ \\(y\\) នៃសមីការ \\((E)\\)។',
              'Find the reals \\(n\\), \\(p\\) and \\(q\\) given that \\(y = 2x^{2}+3x+1\\) is a solution of \\((E)\\), then give the general solution \\(y\\) of \\((E)\\).')
    ]),

    bc('2012',
      'គេឲ្យសមីការ \\(y\'\'-4y\'+5y = 0\\;(E)\\)។',
      'Consider \\(y\'\'-4y\'+5y = 0\\;(E)\\).', [
      p2('a', 'រកចម្លើយទូទៅ \\(y_c\\) នៃសមីការ \\((E)\\)។', 'Find the general solution \\(y_c\\) of \\((E)\\).'),
      p2('b', 'គេដឹងថា \\(y_p = a\\cos x+b\\sin x\\) ជាចម្លើយពិសេសនៃសមីការ \\(y\'\'-4y\'+5y = 4\\cos x-12\\sin x\\;(F)\\) ចំពោះគ្រប់ចំនួនពិត \\(x\\)។ រកចំនួនពិត \\(a\\) និង \\(b\\) ហើយទាញរកចម្លើយទូទៅនៃសមីការ \\((F)\\)។',
              'Given that \\(y_p = a\\cos x+b\\sin x\\) is a particular solution of \\(y\'\'-4y\'+5y = 4\\cos x-12\\sin x\\;(F)\\) for every real \\(x\\), find \\(a\\) and \\(b\\), then deduce the general solution of \\((F)\\).')
    ]),

    bc('2013',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E_1): -y\'\'-y\'+6y = 6x^{2}-2x+4\\)។',
      'Consider \\((E_1): -y\'\'-y\'+6y = 6x^{2}-2x+4\\).', [
      p2('a', 'ដោះស្រាយសមីការ \\((E_2): -y\'\'-y\'+6y = 0\\)។', 'Solve \\((E_2): -y\'\'-y\'+6y = 0\\).'),
      p2('b', 'រកពហុធា \\(p(x) = ax^{2}+bx+c\\) ដែលជាចម្លើយមួយនៃសមីការ \\((E_1)\\) រួចទាញរកចម្លើយទូទៅនៃ \\((E_1)\\)។',
              'Find the polynomial \\(p(x) = ax^{2}+bx+c\\) which solves \\((E_1)\\), then deduce the general solution of \\((E_1)\\).')
    ]),

    bc('2014',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'+4y = x^{2}+2x-1\\)។',
      'Consider \\((E): y\'\'+4y = x^{2}+2x-1\\).', [
      p2('a', 'រកអនុគមន៍ \\(f_1(x) = ax^{2}+bx+c\\) ជាចម្លើយរបស់សមីការ \\((E)\\)។',
              'Find the function \\(f_1(x) = ax^{2}+bx+c\\) which solves \\((E)\\).'),
      p2('b', 'បង្ហាញថា បើ \\(f(x)\\) ជាចម្លើយនៃសមីការ \\((E)\\) នោះ \\(g(x) = f(x)-f_1(x)\\) ជាចម្លើយនៃសមីការ \\(y\'\'+4y = 0\\)។',
              'Show that if \\(f(x)\\) solves \\((E)\\), then \\(g(x) = f(x)-f_1(x)\\) solves \\(y\'\'+4y = 0\\).')
    ]),

    bc('2015',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'+2y = 2\\dfrac{e^{-x}}{1+2e^{x}}\\)។',
      'Consider \\((E): y\'+2y = 2\\dfrac{e^{-x}}{1+2e^{x}}\\).', [
      p2('a', 'ផ្ទៀងផ្ទាត់ថាអនុគមន៍ \\(f\\) ដែល \\(f(x) = e^{-2x}\\ln\\left(1+2e^{x}\\right)\\) ជាចម្លើយនៃ \\((E)\\)។',
              'Verify that the function \\(f\\) with \\(f(x) = e^{-2x}\\ln\\left(1+2e^{x}\\right)\\) is a solution of \\((E)\\).'),
      p2('b', 'បង្ហាញថាអនុគមន៍ \\(\\varphi\\) ជាចម្លើយនៃ \\((E)\\) លុះត្រាតែ \\((\\varphi-f)\\) ជាចម្លើយនៃសមីការ \\((E\'): y\'+2y = 0\\)។',
              'Show that \\(\\varphi\\) is a solution of \\((E)\\) if and only if \\(\\varphi-f\\) is a solution of \\((E\'): y\'+2y = 0\\).')
    ]),

    bc('2016',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'+2y\'-3y = 0\\)។',
      'Consider \\((E): y\'\'+2y\'-3y = 0\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសមួយនៃសមីការ \\((E)\\) ដែល \\(y(0) = 1\\), \\(y\'(0) = e\\)។ (\\(e\\) ជាចំនួនពិតដែល \\(\\ln e = 1\\))',
              'Find the particular solution of \\((E)\\) with \\(y(0) = 1\\) and \\(y\'(0) = e\\). (\\(e\\) is the real number with \\(\\ln e = 1\\).)')
    ]),

    bc('2017',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'-3y\'+2y = 0\\)។',
      'Consider \\((E): y\'\'-3y\'+2y = 0\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសមួយនៃសមីការ \\((E)\\) ដែល \\(y(0) = 1\\) និង \\(y\'(1) = 2e^{2}\\)។',
              'Find the particular solution of \\((E)\\) with \\(y(0) = 1\\) and \\(y\'(1) = 2e^{2}\\).')
    ]),

    bc('2018',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'+4y\' = 5y\\)។',
      'Consider \\((E): y\'\'+4y\' = 5y\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសមួយនៃសមីការ \\((E)\\) បើគេដឹងថាក្រាប \\((C)\\) នៃអនុគមន៍ចម្លើយនេះកាត់តាមចំណុច \\((0,3)\\) ហើយបន្ទាត់ប៉ះទៅក្រាប \\((C)\\) ត្រង់ចំណុចនេះមានមេគុណប្រាប់ទិសស្មើ \\(-3\\)។',
              'Find the particular solution whose curve \\((C)\\) passes through \\((0,3)\\) and whose tangent to \\((C)\\) there has slope \\(-3\\).')
    ]),

    bc('2019',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\(y\'\'+3y\'+3y = 2y\'+5y\\;(E)\\)។',
      'Consider \\(y\'\'+3y\'+3y = 2y\'+5y\\;(E)\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែលនេះ។', 'Solve this differential equation.'),
      p2('b', 'បង្ហាញថាអនុគមន៍ \\(y = -e^{-2x}+2e^{x}\\) ជាចម្លើយពិសេសមួយនៃសមីការ \\((E)\\)។',
              'Show that \\(y = -e^{-2x}+2e^{x}\\) is a particular solution of \\((E)\\).')
    ]),

    bc('2021',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\' = -4y\\)។',
      'Consider \\((E): y\'\' = -4y\\).', [
      p2('a', 'បង្ហាញថា \\(y = \\lambda\\cos 2x+\\mu\\sin 2x\\) ដែល \\(\\lambda,\\mu\\) ជាចំនួនពិត ជាចម្លើយរបស់សមីការ \\((E)\\)។',
              'Show that \\(y = \\lambda\\cos 2x+\\mu\\sin 2x\\), where \\(\\lambda,\\mu\\) are real, is a solution of \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសរបស់សមីការ \\((E)\\) ដែល \\(y\'\'(0) = 1\\) និង \\(y\'(0) = 0\\)។',
              'Find the particular solution of \\((E)\\) with \\(y\'\'(0) = 1\\) and \\(y\'(0) = 0\\).')
    ]),

    bc('2022',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'+y = 2(x+1)e^{-x}\\)។',
      'Consider \\((E): y\'+y = 2(x+1)e^{-x}\\).', [
      p2('a', 'បង្ហាញថាអនុគមន៍ \\(y_0\\) កំណត់លើ \\(\\mathbb{R}\\) ដោយ \\(y_0(x) = \\left(x^{2}+2x\\right)e^{-x}\\) ជាចម្លើយមួយនៃសមីការ \\((E)\\)។',
              'Show that the function \\(y_0\\) defined on \\(\\mathbb{R}\\) by \\(y_0(x) = \\left(x^{2}+2x\\right)e^{-x}\\) is a solution of \\((E)\\).'),
      p2('b', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E\'): y\'+y = 0\\) ដែលផ្ទៀងផ្ទាត់ \\(y(0) = e\\)។',
              'Solve \\((E\'): y\'+y = 0\\) subject to \\(y(0) = e\\).')
    ]),

    bc('2023',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): 3y\'\' = 9y-6y\'\\)។',
      'Consider \\((E): 3y\'\' = 9y-6y\'\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសមួយរបស់សមីការ \\((E)\\) ដែល \\(y(0) = 1\\) និង \\(y\'(1) = e\\)។',
              'Find the particular solution of \\((E)\\) with \\(y(0) = 1\\) and \\(y\'(1) = e\\).')
    ]),

    bc('2024',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'+y = e^{-x}\\)។',
      'Consider \\((E): y\'+y = e^{-x}\\).', [
      p2('a', 'បង្ហាញថាអនុគមន៍ \\(u\\) កំណត់លើសំណុំចំនួនពិត \\(\\mathbb{R}\\) ដោយ \\(u(x) = xe^{-x}\\) ជាចម្លើយមួយរបស់សមីការ \\((E)\\)។',
              'Show that the function \\(u\\) defined on \\(\\mathbb{R}\\) by \\(u(x) = xe^{-x}\\) is a solution of \\((E)\\).'),
      p2('b', 'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E\'): y\'+y = 0\\)។ ដោះស្រាយសមីការ \\((E\')\\)។',
              'Consider \\((E\'): y\'+y = 0\\). Solve \\((E\')\\).'),
      p2('c', 'តាង \\(v\\) ជាអនុគមន៍កំណត់ និងមានដេរីវេលើ \\(\\mathbb{R}\\)។ បង្ហាញថា \\(v\\) ជាចម្លើយនៃសមីការ \\((E)\\) លុះត្រាតែអនុគមន៍ \\(v-u\\) ជាចម្លើយមួយរបស់សមីការ \\((E\')\\)។ រួចទាញយករកចម្លើយរបស់សមីការ \\((E)\\)។',
              'Let \\(v\\) be a function defined and differentiable on \\(\\mathbb{R}\\). Show that \\(v\\) solves \\((E)\\) if and only if \\(v-u\\) solves \\((E\')\\), then deduce the solution of \\((E)\\).')
    ]),

    bc('2025',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\' = 3y-2y\'\\)។',
      'Consider \\((E): y\'\' = 3y-2y\'\\).', [
      p2('a', 'ដោះស្រាយសមីការឌីផេរ៉ង់ស្យែល \\((E)\\)។', 'Solve \\((E)\\).'),
      p2('b', 'រកចម្លើយពិសេសមួយនៃសមីការ \\((E)\\) ដែល \\(y(0) = 1\\) និង \\(y\'(1) = e\\)។ (\\(e\\) ជាចំនួនពិតដែល \\(\\ln e = 1\\))',
              'Find the particular solution of \\((E)\\) with \\(y(0) = 1\\) and \\(y\'(1) = e\\). (\\(e\\) is the real number with \\(\\ln e = 1\\).)')
    ]),

    bc('202…?',
      'គេមានសមីការឌីផេរ៉ង់ស្យែល \\((E): y\'\'-y = 0\\) លើចន្លោះ \\((-\\infty,+\\infty)\\)។',
      'Consider \\((E): y\'\'-y = 0\\) on \\((-\\infty,+\\infty)\\).', [
      p2('a', 'បង្ហាញថា \\(y_1 = e^{x}\\) និង \\(y_2 = e^{-x}\\) ផ្ទៀងផ្ទាត់សមីការ \\((E)\\)។',
              'Show that \\(y_1 = e^{x}\\) and \\(y_2 = e^{-x}\\) satisfy \\((E)\\).'),
      p2('b', 'បង្ហាញថា \\(y = c_1e^{x}+c_2e^{-x}\\) ផ្ទៀងផ្ទាត់សមីការ \\((E): y\'\'-y = 0\\) លើចន្លោះ \\((-\\infty,+\\infty)\\) ដែល \\(c_1\\) និង \\(c_2\\) ជាចំនួនថេរ។',
              'Show that \\(y = c_1e^{x}+c_2e^{-x}\\) satisfies \\((E): y\'\'-y = 0\\) on \\((-\\infty,+\\infty)\\), where \\(c_1\\) and \\(c_2\\) are constants.')
    ])
  ];

  global.MATH_BANK = { key: 'diff', lesson: LESSON, mc: MC, exercises: WR, bac: BACC };
})(window);
